...
extension UInt {
    ...
    ///
    @inlinable static func truncating(digits: ANK.UnsafeUTF8, radix: Int) -> Self? {
...
extension String {
    ...
    alphabet: MaxRadixAlphabetEncoder, prefix: ANK.UnsafeUTF8, suffix: ANK.UnsafeUTF8) -> String {
    ...
    alphabet: MaxRadixAlphabetEncoder, body: (ANK.UnsafeUTF8) -> T) -> T {
        ...
        return Swift.withUnsafeTemporaryAllocation(of: UInt8.self, capacity: radix.exponent) { utf8 in
            ...
            //=----------------------------------=
            return body(ANK.UnsafeUTF8(rebasing: utf8[index...]))
        }
    }
}
