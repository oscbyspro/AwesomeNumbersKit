...
final class Int192BenchmarksOnNumbers: XCTestCase {
    ...
    func testSignitude() {
        var abc = _blackHoleIdentity(S(x64: X(0, 1, 2)))
    ...
    func testMagnitude() {
        var abc = _blackHoleIdentity(M(x64: X(0, 1, 2)))
    ...
    func testSignedMagnitude() {
        var abc = _blackHoleIdentity(ANKSigned(M(x64: X(0, 1, 2)), as: .plus ))
        var xyz = _blackHoleIdentity(ANKSigned(M(x64: X(0, 1, 2)), as: .minus))
