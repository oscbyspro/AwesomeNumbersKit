...
final class Int192TestsOnWords: XCTestCase {
    ...
    func testLeadingZeroBitCount() {
        ...
        XCTAssertEqual(T(x64:(~0, ~0, ~0)).leadingZeroBitCount,  64 * 0)
    ...
    func testMostSignificantBit() {
        ...
        XCTAssertEqual(T(x64:(~0, ~0, ~0)).mostSignificantBit,  true )
    ...
    func testLeastSignificantBit() {
        ...
        XCTAssertEqual(T(x64:(~0, ~0, ~0)).leastSignificantBit, true )
...
final class UInt192TestsOnWords: XCTestCase {
    ...
    func testMinWordCountReportingIsZeroOrMinusOneX64() throws {
        ...
        XCTAssert(T(x64:(~0, ~0, ~0)).minWordCountReportingIsZeroOrMinusOne() == (3, false) as (Int, Bool))
        XCTAssert(T(x64:( 1, ~0, ~0)).minWordCountReportingIsZeroOrMinusOne() == (3, false) as (Int, Bool))
        XCTAssert(T(x64:(~0,  1, ~0)).minWordCountReportingIsZeroOrMinusOne() == (3, false) as (Int, Bool))
        XCTAssert(T(x64:(~0, ~0,  1)).minWordCountReportingIsZeroOrMinusOne() == (3, false) as (Int, Bool))
    }
    ...
    func testMinWordCountReportingIsZeroOrMinusOneX32() throws {
        ...
        XCTAssert(T(x32:(~0, ~0, ~0, ~0, ~0, ~0)).minWordCountReportingIsZeroOrMinusOne() == (6, false) as (Int, Bool))
        XCTAssert(T(x32:( 1, ~0, ~0, ~0, ~0, ~0)).minWordCountReportingIsZeroOrMinusOne() == (6, false) as (Int, Bool))
        XCTAssert(T(x32:(~0,  1, ~0, ~0, ~0, ~0)).minWordCountReportingIsZeroOrMinusOne() == (6, false) as (Int, Bool))
        XCTAssert(T(x32:(~0, ~0,  1, ~0, ~0, ~0)).minWordCountReportingIsZeroOrMinusOne() == (6, false) as (Int, Bool))
        XCTAssert(T(x32:(~0, ~0, ~0,  1, ~0, ~0)).minWordCountReportingIsZeroOrMinusOne() == (6, false) as (Int, Bool))
        XCTAssert(T(x32:(~0, ~0, ~0, ~0,  1, ~0)).minWordCountReportingIsZeroOrMinusOne() == (6, false) as (Int, Bool))
        XCTAssert(T(x32:(~0, ~0, ~0, ~0, ~0,  1)).minWordCountReportingIsZeroOrMinusOne() == (6, false) as (Int, Bool))
    }
}
