...
final class Int192TestsOnNumbers: XCTestCase {
    ...
    func testZero() {
        ANKAssertNumbers(from: T(   ), default:  T(x64: X(0, 0, 0)))
        ANKAssertNumbers(from: T.zero, default:  T(x64: X(0, 0, 0)))
    }
    
    func testEdges() {
        ANKAssertNumbers(from: T.min,  default:  T(x64: X(0, 0, 1 << 63)))
        ANKAssertNumbers(from: T.max,  default: ~T(x64: X(0, 0, 1 << 63)))
    }
    ...
    func testFromInt() {
        ANKAssertNumbers(from: Int.min, default: ~T(x64: X(UInt64(Int.max), 0, 0)))
        ANKAssertNumbers(from: Int.max, default:  T(x64: X(UInt64(Int.max), 0, 0)))
    }
    
    func testFromIntAsDigit() {
        ANKAssertNumbers(from: T(digit: Int.min), default: ~T(x64: X(UInt64(Int.max), 0, 0)))
        ANKAssertNumbers(from: T(digit: Int.max), default:  T(x64: X(UInt64(Int.max), 0, 0)))
    }
    ...
    func testFromUInt() {
        ANKAssertNumbers(from: UInt.min, default: T(x64: X(UInt64(UInt.min), 0, 0)))
        ANKAssertNumbers(from: UInt.max, default: T(x64: X(UInt64(UInt.max), 0, 0)))
    }
    
    func testFromUIntAsBits() {
        ANKAssertNumbers(from: T(_truncatingBits: UInt.min), default: T(x64: X(UInt64(UInt.min), 0, 0)))
        ANKAssertNumbers(from: T(_truncatingBits: UInt.max), default: T(x64: X(UInt64(UInt.max), 0, 0)))
    }
    ...
    func testToInt64() {
        ANKAssertNumbers(from: T(x64: X( 1,  0,  0)), default: Int64( 1))
        ANKAssertNumbers(from: T(x64: X(~0,  0,  0)), exactly: nil, clamping: Int64.max, truncating: -1)
        ANKAssertNumbers(from: T(x64: X( 1,  1,  1)), exactly: nil, clamping: Int64.max, truncating:  1)
        ANKAssertNumbers(from: T(x64: X(~0, ~0, ~0)), default: Int64(-1))
    }
    ...
    func testToUInt64() {
        ANKAssertNumbers(from: T(x64: X( 1,  0,  0)), default: UInt64( 1))
        ANKAssertNumbers(from: T(x64: X(~0,  0,  0)), default: UInt64.max)
        ANKAssertNumbers(from: T(x64: X( 1,  1,  1)), exactly: nil, clamping: ~0, truncating: UInt64( 1))
        ANKAssertNumbers(from: T(x64: X(~0, ~0, ~0)), exactly: nil, clamping:  0, truncating: UInt64.max)
    }
    ...
    func testToDoubleWidth() {
        ANKAssertNumbers(from: T(x64: X( 1,  0,  0)), default: T2(high:  0, low: M(x64: X( 1,  0,  0))))
        ANKAssertNumbers(from: T(x64: X(~0,  0,  0)), default: T2(high:  0, low: M(x64: X(~0,  0,  0))))
        ANKAssertNumbers(from: T(x64: X( 1,  1,  1)), default: T2(high:  0, low: M(x64: X( 1,  1,  1))))
        ANKAssertNumbers(from: T(x64: X(~0, ~0, ~0)), default: T2(high: -1, low: M(x64: X(~0, ~0, ~0))))
    }
    ...
    func testFromFloat32() {
        ...
        XCTAssertEqual(T(exactly:  pow(2, Float32(64 * 0 - 0))), T(x64: X(1,       0, 0)))
    ...
    func testFromFloat64() {
        ...
        XCTAssertEqual(T(exactly:  pow(2, Float64(64 * 0 - 0))), T(x64: X(1,       0, 0)))
    ...
    func testFromLiteral() {
        XCTAssertEqual(T(x64: X( 0,  0,  0)),  0)
        XCTAssertEqual(T(x64: X(~0,  0,  0)),  18446744073709551615)
        XCTAssertEqual(T(x64: X(~0, ~0,  0)),  340282366920938463463374607431768211455)
        XCTAssertEqual(T(x64: X(~0, ~0, ~0)), -1)
...
final class UInt192TestsOnNumbers: XCTestCase {
    ...
    func testEdges() {
        ANKAssertNumbers(from: T.min,  default:  T(x64: X(0, 0, 0)))
        ANKAssertNumbers(from: T.max,  default: ~T(x64: X(0, 0, 0)))
    }
    ...
    func testFromInt() {
        ANKAssertNumbers(from: Int.min, exactly: nil, clamping: 0, truncating: ~T(x64: X(UInt64(Int.max), 0, 0)))
        ANKAssertNumbers(from: Int.max, default: /*-------------------------*/  T(x64: X(UInt64(Int.max), 0, 0)))
    }
    ...
    func testFromUIntAsDigit() {
        ANKAssertNumbers(from: T(digit: UInt.min), default: T(x64: X(UInt64(UInt.min), 0, 0)))
        ANKAssertNumbers(from: T(digit: UInt.max), default: T(x64: X(UInt64(UInt.max), 0, 0)))
    }
    ...
    func testToInt64() {
        ANKAssertNumbers(from: T(x64: X( 1,  0,  0)), default: Int64( 1))
        ANKAssertNumbers(from: T(x64: X(~0,  0,  0)), exactly: nil, clamping: Int64.max, truncating: ~0)
        ANKAssertNumbers(from: T(x64: X( 1,  1,  1)), exactly: nil, clamping: Int64.max, truncating:  1)
        ANKAssertNumbers(from: T(x64: X(~0, ~0, ~0)), exactly: nil, clamping: Int64.max, truncating: ~0)
    }
    
    func testFromInt64() {
        ANKAssertNumbers(from: Int64.min, exactly: nil, clamping: 0, truncating: ~T(x64: X(UInt64(Int64.max), 0, 0)))
        ANKAssertNumbers(from: Int64.max, default: /*-------------------------*/  T(x64: X(UInt64(Int64.max), 0, 0)))
    }
    ...
    func testToUInt64() {
        ANKAssertNumbers(from: T(x64: X( 1,  0,  0)), default: UInt64( 1))
        ANKAssertNumbers(from: T(x64: X(~0,  0,  0)), default: UInt64.max)
        ANKAssertNumbers(from: T(x64: X( 1,  1,  1)), exactly: nil, clamping: UInt64.max, truncating:  1)
        ANKAssertNumbers(from: T(x64: X(~0, ~0, ~0)), exactly: nil, clamping: UInt64.max, truncating: ~0)
    }
    
    func testFromUInt64() {
        ANKAssertNumbers(from: UInt64.min, default: T(x64: X(UInt64.min, 0, 0)))
        ANKAssertNumbers(from: UInt64.max, default: T(x64: X(UInt64.max, 0, 0)))
    }
    ...
    func testToDoubleWidth() {
        ANKAssertNumbers(from: T(x64: X( 1,  0,  0)), default: T2(low: M(x64: X( 1,  0,  0))))
        ANKAssertNumbers(from: T(x64: X(~0,  0,  0)), default: T2(low: M(x64: X(~0,  0,  0))))
        ANKAssertNumbers(from: T(x64: X( 1,  1,  1)), default: T2(low: M(x64: X( 1,  1,  1))))
        ANKAssertNumbers(from: T(x64: X(~0, ~0, ~0)), default: T2(low: M(x64: X(~0, ~0, ~0))))
    }
    ...
    func testFromLiteral() {
        ...
        XCTAssertEqual(T(x64: X(~0,  0,  0)), 18446744073709551615)
        XCTAssertEqual(T(x64: X(~0, ~0,  0)), 340282366920938463463374607431768211455)
        XCTAssertEqual(T(x64: X(~0, ~0, ~0)), 6277101735386680763835789423207666416102355444464034512895)
