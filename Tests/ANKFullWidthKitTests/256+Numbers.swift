...
final class Int256TestsOnNumbers: XCTestCase {
    ...
    func testZero() {
        ANKAssertNumbers(from: T(   ), default:  T(x64: X(0, 0, 0, 0)))
        ANKAssertNumbers(from: T.zero, default:  T(x64: X(0, 0, 0, 0)))
    }
    
    func testEdges() {
        ANKAssertNumbers(from: T.min,  default:  T(x64: X(0, 0, 0, 1 << 63)))
        ANKAssertNumbers(from: T.max,  default: ~T(x64: X(0, 0, 0, 1 << 63)))
    }
    ...
    func testFromIntAsDigit() {
        ANKAssertNumbers(from: T(digit: Int.min), default: ~T(x64: X(UInt64(Int.max), 0, 0, 0)))
        ANKAssertNumbers(from: T(digit: Int.max), default:  T(x64: X(UInt64(Int.max), 0, 0, 0)))
    }
    ...
    func testFromUIntAsBits() {
        ANKAssertNumbers(from: T(_truncatingBits: UInt.min), default: T(x64: X(UInt64(UInt.min), 0, 0, 0)))
        ANKAssertNumbers(from: T(_truncatingBits: UInt.max), default: T(x64: X(UInt64(UInt.max), 0, 0, 0)))
    }
...
final class UInt256TestsOnNumbers: XCTestCase {
    ...
    func testEdges() {
        ANKAssertNumbers(from: T.min,  default:  T(x64: X(0, 0, 0, 0)))
        ANKAssertNumbers(from: T.max,  default: ~T(x64: X(0, 0, 0, 0)))
    }
    ...
    func testFromUIntAsDigit() {
        ANKAssertNumbers(from: T(digit: UInt.min), default: T(x64: X(UInt64(UInt.min), 0, 0, 0)))
        ANKAssertNumbers(from: T(digit: UInt.max), default: T(x64: X(UInt64(UInt.max), 0, 0, 0)))
    }
