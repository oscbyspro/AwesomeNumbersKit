...
final class Int256TestsOnComparison: XCTestCase {
    ...
    func testEquating() {
        ...
        XCTAssertEqual(T(x64:(b, b, b, b)), T(x64:(b, b, b, b)))
    }
    ...
    func testComparing() {
        ...
        XCTAssert(T(x64:(b, b, 0, 0)) < T(x64:(b, b, b, 0)))
        XCTAssert(T(x64:(b, b, b, 0)) > T(x64:(b, b, 0, 0)))
        
        XCTAssert(T(x64:(b, b, b, 0)) > T(x64:(b, b, b, b)))
        XCTAssert(T(x64:(b, b, b, b)) < T(x64:(b, b, b, 0)))
    }
