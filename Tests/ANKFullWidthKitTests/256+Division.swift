...
final class Int256TestsOnDivision: XCTestCase {
    ...
    func testQuotientReportingOverflow() {
        ...
        XCTAssert(T(x64:(1, 2, 3, 4)).dividedReportingOverflow(by: T(-2)) == (-T(x64:(0, ~0/2 + 2, 1, 2)), false) as (T, Bool))
    ...
    func testQuotientDividingByDigitReportingOverflow() {
        ...
        XCTAssert(T(x64:(1, 2, 3, 4)).dividedReportingOverflow(by: Int(-2)) == (-T(x64:(0, ~0/2 + 2, 1, 2)), false) as (T, Bool))
    ...
    func testDividingFullWidth() {
        var x: (high: T, low: M)
        //=--------------------------------------=
        x.low  = M(x64:( 6, 17, 35, 61))
        x.high = T(x64:(61, 52, 32,  0))
        
        XCTAssertEqual(T(x64:( 1,  2,  3,  4)).dividingFullWidth(x).quotient,  T(x64:( 5,  6,  7,  8)))
        XCTAssertEqual(T(x64:( 1,  2,  3,  4)).dividingFullWidth(x).remainder, T(x64:( 1,  1,  1,  1)))
        
        XCTAssertEqual(T(x64:( 5,  6,  7,  8)).dividingFullWidth(x).quotient,  T(x64:( 1,  2,  3,  4)))
        XCTAssertEqual(T(x64:( 5,  6,  7,  8)).dividingFullWidth(x).remainder, T(x64:( 1,  1,  1,  1)))
        //=--------------------------------------=
        x.low  = M(x64:(34, 54, 63, 62))
        x.high = T(x64:(34, 16,  5,  0))
        
        XCTAssertEqual(T(x64:( 4,  3,  2,  1)).dividingFullWidth(x).quotient,  T(x64:( 9,  7,  6,  5)))
        XCTAssertEqual(T(x64:( 4,  3,  2,  1)).dividingFullWidth(x).remainder, T(x64:(~1, ~1, ~0,  0)))
        
        XCTAssertEqual(T(x64:( 8,  7,  6,  5)).dividingFullWidth(x).quotient,  T(x64:( 4,  3,  2,  1)))
        XCTAssertEqual(T(x64:( 8,  7,  6,  5)).dividingFullWidth(x).remainder, T(x64:( 2,  2,  2,  2)))
        //=--------------------------------------=
        x.low  = M(x64:(~1, ~0, ~0, ~0))
        x.high = T(x64:(~0, ~0, ~0, ~0))
        
        XCTAssertEqual(T(x64:( 1,  0,  0,  0)).dividingFullWidth(x).quotient,  T(x64:(~1, ~0, ~0, ~0)))
        XCTAssertEqual(T(x64:( 1,  0,  0,  0)).dividingFullWidth(x).remainder, T(x64:( 0,  0,  0,  0)))
        
        XCTAssertEqual(T(x64:(~0, ~0, ~0, ~0)).dividingFullWidth(x).quotient,  T(x64:( 2,  0,  0,  0)))
        XCTAssertEqual(T(x64:(~0, ~0, ~0, ~0)).dividingFullWidth(x).remainder, T(x64:( 0,  0,  0,  0)))
    }
...
final class UInt256TestsOnDivision: XCTestCase {
    ...
    func testQuotientDividingByDigitReportingOverflow() {
        ...
        XCTAssert(T(x64:(1, 2, 3, 4)).dividedReportingOverflow(by: UInt(2)) == (T(x64:(0, ~0/2 + 2, 1, 2)), false) as (T, Bool))
    }
