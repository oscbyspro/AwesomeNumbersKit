...
final class Int192TestsOnDivision: XCTestCase {
    ...
    func testQuotientReportingOverflow() {
        ...
        XCTAssert(T(x64:(1, 2, 3)).dividedReportingOverflow(by: T(-2)) == (-T(x64:(0, b/2 + 2, 1)), false) as (T, Bool))
    ...
    func testQuotientDividingByDigitReportingOverflow() {
        ...
        XCTAssert(T(x64:(1, 2, 3)).dividedReportingOverflow(by: Int(-2)) == (-T(x64:(0, b/2 + 2, 1)), false) as (T, Bool))
    ...
    func testDividingFullWidth() {
        ...
        //=--------------------------------------=
        dividend.low  = M(x64:(~1,  b,  b))
        dividend.high = T(x64:( b,  b,  b))

        XCTAssertEqual(T(x64:(1, 0, 0)).dividingFullWidth(dividend).quotient,  T(x64:(~1,  b,  b)))
        XCTAssertEqual(T(x64:(1, 0, 0)).dividingFullWidth(dividend).remainder, T(x64:( 0,  0,  0)))

        XCTAssertEqual(T(x64:(b, b, b)).dividingFullWidth(dividend).quotient,  T(x64:( 2,  0,  0)))
        XCTAssertEqual(T(x64:(b, b, b)).dividingFullWidth(dividend).remainder, T(x64:( 0,  0,  0)))
    }
...
final class UInt192TestsOnDivision: XCTestCase {
    ...
    func testQuotientReportingOverflow() {
        ...
        XCTAssert(T(x64:(1, 2, 3)).dividedReportingOverflow(by: T(1)) == (T(x64:(1, 2,       3)), false) as (T, Bool))
        XCTAssert(T(x64:(1, 2, 3)).dividedReportingOverflow(by: T(2)) == (T(x64:(0, 2 + b/2, 1)), false) as (T, Bool))
    }
    ...
    func testQuotientDividingByDigitReportingOverflow() {
        ...
        XCTAssert(T(x64:(1, 2, 3)).dividedReportingOverflow(by: UInt(2)) == (T(x64:(0, b/2 + 2, 1)), false) as (T, Bool))
    }
