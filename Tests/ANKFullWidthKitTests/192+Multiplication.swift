...
final class Int192TestsOnMultiplication: XCTestCase {
    ...
    func testMultiplyingByDigit() {
        ANKAssertMultiplication( T(x64: X(1, 2, 3)),  Int(0),  T(x64: X(0, 0, 0)))
        ANKAssertMultiplication( T(x64: X(1, 2, 3)), -Int(0), -T(x64: X(0, 0, 0)))
        ANKAssertMultiplication(-T(x64: X(1, 2, 3)),  Int(0), -T(x64: X(0, 0, 0)))
        ANKAssertMultiplication(-T(x64: X(1, 2, 3)), -Int(0),  T(x64: X(0, 0, 0)))
        
        ANKAssertMultiplication( T(x64: X(1, 2, 3)),  Int(1),  T(x64: X(1, 2, 3)))
        ANKAssertMultiplication( T(x64: X(1, 2, 3)), -Int(1), -T(x64: X(1, 2, 3)))
        ANKAssertMultiplication(-T(x64: X(1, 2, 3)),  Int(1), -T(x64: X(1, 2, 3)))
        ANKAssertMultiplication(-T(x64: X(1, 2, 3)), -Int(1),  T(x64: X(1, 2, 3)))
        
        ANKAssertMultiplication( T(x64: X(1, 2, 3)),  Int(2),  T(x64: X(2, 4, 6)))
        ANKAssertMultiplication( T(x64: X(1, 2, 3)), -Int(2), -T(x64: X(2, 4, 6)))
        ANKAssertMultiplication(-T(x64: X(1, 2, 3)),  Int(2), -T(x64: X(2, 4, 6)))
        ANKAssertMultiplication(-T(x64: X(1, 2, 3)), -Int(2),  T(x64: X(2, 4, 6)))
    }
    ...
    func testMultiplyingByDigitUsingLargeValues() {
        ANKAssertMultiplication(T(x64: X( 1,  2,  3)),  Int(2), T(x64: X( 2,  4,  6)),  Int(0))
        ANKAssertMultiplication(T(x64: X( 1,  2,  3)), -Int(2), T(x64: X(~1, ~4, ~6)), -Int(1))
        ANKAssertMultiplication(T(x64: X(~1, ~2, ~3)),  Int(2), T(x64: X(~3, ~4, ~6)), -Int(1))
        ANKAssertMultiplication(T(x64: X(~1, ~2, ~3)), -Int(2), T(x64: X( 4,  4,  6)),  Int(0))
    }
...
final class UInt192TestsOnMultiplication: XCTestCase {
    ...
    func testMultipliedByDigit() {
        ANKAssertMultiplication(T(x64: X(1, 2, 3)), UInt(0), T(x64: X(0, 0, 0)))
        ANKAssertMultiplication(T(x64: X(1, 2, 3)), UInt(1), T(x64: X(1, 2, 3)))
        ANKAssertMultiplication(T(x64: X(1, 2, 3)), UInt(2), T(x64: X(2, 4, 6)))
    }
    
    func testMultiplyingByDigitUsingLargeValues() {
        ANKAssertMultiplication(T(x64: X(~1, ~2, ~3)), UInt(2), T(x64: X(~3, ~4, ~6)), UInt(1), true )
        ANKAssertMultiplication(T(x64: X( 1,  2,  3)), UInt(2), T(x64: X( 2,  4,  6)), UInt(0), false)
    }
