...
final class UInt192TestsOnText: XCTestCase {
    ...
    func testDecodingStringsWithOrWithoutSignAndRadixLiteral() {
        XCTAssertEqual(T(decoding:  "1234567890"),         T(1234567890         as UInt64))
        XCTAssertEqual(T(decoding:  "0x123456789abcdef0"), T(0x123456789abcdef0 as UInt64))
        XCTAssertEqual(T(decoding:  "0o1234567012345670"), T(0o1234567012345670 as UInt64))
        XCTAssertEqual(T(decoding:  "0b1010101010101010"), T(0b1010101010101010 as UInt64))
